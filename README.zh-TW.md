# Horae - 時光記憶 v1.12.7 | SillyTavern 記憶增強插件
...
- **SillyTavern**: 1.12.7+（AI 分析功能需求 1.13.5+）
- **平台**: 電腦端 + 行動端雙端適配
...
希望 Horae 支援你的語言？歡迎提交 [Issue](https://github.com/SenriYuki，柏柏/SillyTavern-Horae/issues) 或直接 PR 翻譯檔案！
